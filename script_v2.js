...
// ==========================================================================
// CODE D'ACTIVATION DU POP-UP D'ANNIVERSAIRE POUR JULIE
// ==========================================================================
document.addEventListener("DOMContentLoaded", function() {
  ...
  if (popup && closeBtn) {
    if (!localStorage.getItem('julie_birthday_popup_seen')) {
    ...
    closeBtn.addEventListener('click', function() {
      ...
      setTimeout(function() {
        popup.style.display = 'none';
        localStorage.setItem('julie_birthday_popup_seen', 'true');
      }, 500);
    });
  }
});
