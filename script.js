...
const tickets = [
  ...
  "q": "<p><strong>Les émotions ne se voient pas toujours au premier regard.</strong></p><p>Observe attentivement le texte. Toutes les lettres semblent rouges, mais plusieurs nuances différentes sont cachées. Une seule nuance permet de découvrir un véritable mot.</p><br><p>Les ren<span class='n4'>v</span>contres les plus marquantes commencent parfois sans prévenir. Il suffit d'un reg<span class='n2'>t</span>ard, d'un sourire ou d'un simple instant pour que quelque chose change. Avec le temps, certaines émotions deviennent plus fortes tandis que d'autres disparaissent sans laisser de trace. Rien ne presse lorsqu'on apprend réellement à connaître quelqu'un, mais chaque petit détail peut avoir son importance. Les souvenirs se construisent au fil des jours, des éclats de rire, des silences et des moments partagés. Ce sont souvent les gestes les plus simples qui laissent les plus belles empreintes. Parfois, un regard suffit à dire davantage que de longues phrases, et les plus belles histoires s'écrivent sans même que l'on s'en aperçoive.</p><br><p>par<span class='n1'>p</span>mi les émot<span class='n3'>k</span>ions sinc<span class='n5'>s</span>ères se cachent parfois des instants que l'on n'oublie jamais. Les h<span class='n2'>r</span>abitudes changent avec le temps mais certaines sens<span class='n1'>a</span>tions restent intactes. Un sou<span class='n4'>e</span>rire peut transformer une journée entière, tandis qu'un simple geste peut rassurer davantage que de longs discours. Chacun avance à son rythme, découvre l'autre progressivement et construit quelque chose de précieux. Les regards deviennent plus confiants, les silences plus agréables et les souvenirs plus nombreux. Il arrive même que les plus belles émotions naissent sans que l'on puisse vraiment expliquer pourquoi. co<span class='n1'>s</span>mme si tout devenait naturellement plus simple. Les petits détails prennent davantage d'importance lorsque l'on partage quelque chose de vrai. cert<span class='n5'>a</span>ins instants semblent durer une éternité, alors que d'autres passent beaucoup trop vite. Les plus belles histoires commencent souvent lorsqu'on cesse simplement d'avoir peur. certa<span class='n1'>s</span>ins moments restent gravés bien plus longtemps que les autres. Les liens deviennent alors plus forts, plus sincères et plus profonds. Il suffit parfois d'un rien pour tout changer, d'une émotion partagée ou d'un instant suspendu. conf<span class='n2'>a</span>ire confiance à quelqu'un demande du temps mais rend chaque souvenir encore plus précieux. il dev<span class='n1'>i</span>ent alors plus facile d'être soi-même sans avoir besoin de jouer un rôle. Certaines émotions restent discrètes mais ne disparaissent jamais vraiment. Elles grandissent doucement jusqu'à prendre toute leur place. les hist<span class='n3'>o</span>ires qui comptent vraiment sont souvent les plus simples. pers<span class='n1'>o</span>nne ne peut prévoir ce que réserve l'avenir mais chacun peut choisir d'avancer avec confiance. natu<span class='n1'>n</span>ellement, certaines choses ne demandent qu'à être découvertes.</p>",
